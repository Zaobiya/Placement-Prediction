...
def predict_placements(request):
    df = pd.read_csv('D:/Project/mysite/staticfiles/collegePlace.csv')
    ...
    with open('D:/Project/mysite/staticfiles/model.pkl', 'wb') as f:
        pickle.dump(classify, f)

    # Load the model
    with open('D:/Project/mysite/staticfiles/model.pkl', 'rb') as f:
        model = pickle.load(f)
